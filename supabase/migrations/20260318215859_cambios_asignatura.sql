...
CREATE TRIGGER trigger_track_cambios_asignatura BEFORE INSERT OR DELETE OR UPDATE ON public.asignaturas FOR EACH ROW EXECUTE FUNCTION public.fn_track_cambios_asignatura();
